...
API: `com.alibaba.fenxiao.crossborder:product.analyze.getRepurchaseRateTrendNew:1` · Category: 商机  
...
| `startDate` | java.lang.String | 是 | 查询起始时间 | 20240701(起始时间和截止时间不要超过一个月） |
| `endDate` | java.lang.String | 是 | 查询截止时间 | 20240710 |
...
| `value` | java.lang.String | 是 | 指标数据 | 10% |
