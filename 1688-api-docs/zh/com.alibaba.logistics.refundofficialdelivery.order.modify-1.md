...
API: `com.alibaba.logistics:refundofficialdelivery.order.modify:1` · Category: 官方退上门取件  
...
| 字段 | 类型 | 必填 | 描述 | 示例 |
|---|---|---|---|---|
| `param` | [message:alibaba.ocean.openplatform.biz.logistics.param.OfficialDeliveryOrderModifyParam](#m-alibaba-ocean-openplatform-biz-logistics-param-officialdeliveryordermodifyparam) | 是 |  |  |
...
| `dateStr` | java.lang.String | 是 | 上门揽日期yyyy-MM-dd | 2024-07-11 |
| `gmtAcceptEnd` | java.lang.String | 是 | 上门揽时间起 HH:mm | 9:00 |
| `gmtAcceptStart` | java.lang.String | 是 | 上门揽时间止 HH:mm | 21:00 |
...
| 字段 | 类型 | 必填 | 描述 | 示例 |
|---|---|---|---|---|
| `result` | [message:alibaba.openapi.shared.common.refundofficialdelivery.order.modify.ResultModel](#m-alibaba-openapi-shared-common-refundofficialdelivery-order-modify-resultmodel) | 是 |  |  |
...
| `result` | java.lang.Boolean | 是 | 修改是否成功 | true |
