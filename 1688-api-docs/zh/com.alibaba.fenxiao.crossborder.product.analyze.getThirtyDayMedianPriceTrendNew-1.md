...
API: `com.alibaba.fenxiao.crossborder:product.analyze.getThirtyDayMedianPriceTrendNew:1` · Category: 商机  
...
| 字段 | 类型 | 必填 | 描述 | 示例 |
|---|---|---|---|---|
| `trendQueryParam` | [message:com.alibaba.cbu.offer.param.OfferSellTrendQueryParam](#m-com-alibaba-cbu-offer-param-offerselltrendqueryparam) | 是 |  |  |
...
| `startDate` | java.lang.String | 是 | 查询起始时间 | 20240701(开始时间到截止时间不要超过1个月) |
...
| `result` | [message:com.alibaba.cbu.offer.model.OfferSellTrendDataModel[]](#m-com-alibaba-cbu-offer-model-offerselltrenddatamodel[]) | 是 | 结果 | 结果	[ { "date": "20240701", "value": "20" }, { "date": "20240702", "value": "20" }, { "date": "20240703", "value": "20" }, { "date": "20240704", "value": "20" }, { "date": "20240705", "value": "" } ] |
...
| 字段 | 类型 | 必填 | 描述 | 示例 |
|---|---|---|---|---|
| `date` | java.lang.String | 是 | 查询指标数据对应的日期 | 20240701 |
| `value` | java.lang.String | 是 | 指标数据 | 1.12 |
