...
Topic: `PRODUCT_RELATION_VIEW_PRODUCT_AUDIT` · Group: PRODUCT (商品消息)  
Doc page: https://open.1688.com/doc/topicDetail.htm?id=PRODUCT_RELATION_VIEW_PRODUCT_AUDIT

1688产品审核，关系用户（包含跨境、分销等关系）视角
...
| `status` | String | 是 | 消息类型，具体可为RELATION_VIEW_PRODUCT_EXPIRE、RELATION_VIEW_PRODUCT_NEW_OR_MODIFY、RELATION_VIEW_PRODUCT_DELETE、RELATION_VIEW_PRODUCT_REPOST | RELATION_VIEW_PRODUCT_AUDIT |
