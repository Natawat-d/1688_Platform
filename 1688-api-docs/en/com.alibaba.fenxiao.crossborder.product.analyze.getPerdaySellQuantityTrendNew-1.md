# Get daily sales-quantity trend for a product (new)

Original name: 获取商品每日销售数量趋势（新）  
API: `com.alibaba.fenxiao.crossborder:product.analyze.getPerdaySellQuantityTrendNew:1` · Category: Market Insights  
...
| Field | Type | Required | Description | Example |
|---|---|---|---|---|
| `tendQueryParam` | [message:com.alibaba.cbu.offer.param.OfferSellTrendQueryParam](#m-com-alibaba-cbu-offer-param-offerselltrendqueryparam) | yes |  |  |
...
| `startDate` | java.lang.String | yes | Query start time | 20240701(起始时间和截止时间不要超过1个月） |
...
| Field | Type | Required | Description | Example |
|---|---|---|---|---|
| `date` | java.lang.String | yes | Date corresponding to the data metric | 20240620 |
| `value` | java.lang.String | yes | Metric data | 100 |
